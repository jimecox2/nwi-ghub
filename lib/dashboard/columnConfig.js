...
export const defaultFields = {
    ...
    tbRemainingDuration: { title: 'Rem. Dur.', width: '150x' },
    tbWork: { title: 'Work', width: '50px' },
    tbAWork: { title: 'A Work', width: '50px' },
    tbWorkRemaining: { title: 'Work Rem.', width: '150x' },
...
export const ganttFields = {
    tbID: { title: 'ID', width: '20px' },
    //tbHierarchyOrder: { title: 'WBS', width: '80px' },
    tbType: { title: 'Type', width: '80px' },
    // tbSubType: { title: "Sub Type", width: "75px" },
    tbName: { title: 'Name of Item', width: '150px' },
    //  tbOwner: { title: 'Owner', width: '120px' },
    //  tbMDEscalationLevel: { title: 'Escalation', width: '120px' },
    tbMDStatus: { title: 'Status', width: '100px' },
    tbStart: { title: 'Start', width: '120px' },
    tbFinish: { title: 'Finish', width: '120px' },
    tbAStart: { title: 'A Start', width: '100px' },
    tbAFinish: { title: 'A Finish', width: '100px' },
    tbDuration: { title: 'Dur', width: '100px' },
    tbRemainingDuration: { title: 'Rem. Dur.', width: '150x' },
...
export const largeTextReport = {
    ...
    tbName: { title: "Name", width: "300px" },
    tbType: { title: "Type", width: "60px" },
    tbOwner: { title: "Owner", width: "100px" },
    ...
    tbStart: { title: "Start", width: "110px" },
    tbFinish: { title: "Finish", width: "110px" },
    tbAStart: { title: "A Start", width: "110px" },
    tbAFinish: { title: "A Finish", width: "110px" },
    tbDuration: { title: "Duration", width: "50px" },
    tbRemainingDuration: { title: "Remaining Duration", width: "75px" },
    tbWork: { title: "Work", width: "50px" },
    tbAWork: { title: "A Work", width: "50px" },
    tbWorkRemaining: { title: "Work Remaining", width: "75px" },
...
export const coreColumnsAB = {
    tbID: { title: 'ID', width: '30px' },
    //tbHierarchyOrder: { title: 'WBS', width: '80px' },
    tbType: { title: 'Type', width: '120px' },
    tbSubType: { title: "Sub Type", width: "75px" },
    tbMDEscalationLevel: { title: 'Escalation', width: '120px' },
    tbName: { title: 'Name of Item', width: '4300px' },
    tbOwner: { title: 'Owner', width: '120px' },
    tbMDStatus: { title: 'Status', width: '100px' },
...
export const coreColumnsABAdv = {
    ...
    tbSubType: { title: "Sub Type", width: "75px" },
    tbMDEscalationLevel: { title: 'Escalation', width: '120px' },
    tbName: { title: 'Name of Item', width: '300px' },
    tbOwner: { title: 'Owner', width: '120px' },
...
export const coreColumnsTB = {
    ...
    tbMDStatus: { title: "Status", width: "110px" },
    ...
    tbMDEscalationLevel: { title: "Escalation Level", width: "110px" },
...
export const coreColumnsCBStd = {
    ...
    tbMDState: { title: 'State', width: '100px' },
    tbWork: { title: 'Hours', width: '150px' },
    ...
    tbStart: { title: 'Start', width: '150px' },
    tbFinish: { title: 'Finish', width: '150px' },
    tbAStart: { title: 'A Start', width: '120px' },
    tbAFinish: { title: 'A Finish', width: '120px' },
...
export const varianceColumnsStd = {
    ...
    tbStart: { title: 'Start', width: '100px' },
    tbFinish: { title: 'Finish', width: '100px' },
    tbAStart: { title: 'A Start', width: '100px' },
    tbAFinish: { title: 'A Finish', width: '100px' },
    ...
    tbDuration: { title: 'Dur', width: '50px' },
    tbRemainingDuration: { title: 'Rem. Dur.', width: '50px' },
    ...
    tbWork: { title: 'Work', width: '50px' },
    tbAWork: { title: 'A Work', width: '50px' },
    tbWorkRemaining: { title: 'Rem Work', width: '50px' },
...
export const varianceColumnsAdv = {
    ...
    tbStart: { title: 'Start', width: '75px' },
    tbFinish: { title: 'Finish', width: '75px' },
    tbAStart: { title: 'A Start', width: '75px' },
    tbAFinish: { title: 'A Finish', width: '75px' },
...
export const randiColumns = {
    tbID: { title: 'ID', width: '70px' },
    tbSubType: { title: 'Type', width: '70px' },
    tbName: { title: 'Name of Item', width: '350px' },
    tbOwner: { title: 'Owner', width: '150px' },
    tbMDStatus: { title: 'Status', width: '100px' },
    tbMDEscalationLevel: { title: 'Escalation', width: '120px' },
...
export const otherFields = {
    ...
    tbMDShowIn: { title: 'Show In', width: '100px' },
...
export const aiResultFields = {
    ...
    tbMDShowIn: { title: "Show in", width: "175px" },
