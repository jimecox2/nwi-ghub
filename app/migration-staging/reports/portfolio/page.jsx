// app/dashboard/reports/portfolio/page.jsx
'use client'
...
/**
 * Enterprise Portfolio Reports Page
 * Shows portfolio status report from the active dashboard source
    ...
    return (
      <div className="container mx-auto p-6">
        <div className="text-center py-12">
          <p className="text-red-600">Please sign in to view portfolio reports.</p>
        </div>
      </div>
    )
  }
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-yellow-800 mb-3">
                You need to create a dashboard source before you can view portfolio reports.
              </p>
              <ol className="list-decimal list-inside text-sm text-yellow-800 space-y-1 mb-4">
                ...
                <li>Return here to view portfolio reports</li>
              </ol>
              <a
    ...
    <div className="container mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500">
          Portfolio-level insights and strategic project analysis (will be extended with additional views)
        </p>
      </div>
